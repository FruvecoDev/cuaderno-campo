        ...
        {activeTab === 'general' && (<div>
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr 0.6fr', gap: '0.75rem' }}>
              ...
              <div className="form-group" style={{ marginBottom: 0 }}><label className="form-label" style={{ fontSize: '0.75rem', fontWeight: '600' }}>Nº Visita</label><input type="number" min="1" className="form-input" value={formData.numero_visita ?? ''} onChange={(e) => setFormData({...formData, numero_visita: e.target.value === '' ? '' : parseInt(e.target.value, 10)})} placeholder="Auto" title="Se asigna automáticamente al crear (1, 2, 3...). Edítalo solo si quieres forzar un número específico." data-testid="input-numero-visita" /></div>
            </div>
          </div>
