                  ...
                  <div>
                    ...
                    <div style={{ 
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                        <span className="badge" style={{ 
                          backgroundColor: getSeverityColor(showAnalysisModal.severity).color, 
                          color: 'white' 
                        }}>
                    ...
                    {showAnalysisModal.description && (
                      <div style={{ marginBottom: '1rem' }}>
                        <label style={{ fontWeight: '600', fontSize: '0.875rem', color: 'hsl(var(--muted-foreground))' }}>Descripción</label>
                    ...
                    {showAnalysisModal.symptoms?.length > 0 && (
                      <div style={{ marginBottom: '1rem' }}>
                        <label style={{ fontWeight: '600', fontSize: '0.875rem', color: 'hsl(var(--muted-foreground))' }}>Síntomas observados</label>
