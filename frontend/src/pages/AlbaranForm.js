            ...
            <div key={index} style={{
              ...
              {item.es_destare ? (
                ...
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: isGuisante && preciosCalidad.length > 0 ? '130px 70px 110px 120px 70px 150px' : '130px 70px 120px 70px 150px', gap: '0.5rem', alignItems: 'center' }}>
                ...
                <div>
                  ...
                  <div style={{ display: 'grid', gridTemplateColumns: isGuisante && preciosCalidad.length > 0 ? '130px 70px 110px 120px 70px 150px' : '130px 70px 120px 70px 150px', gap: '0.5rem', alignItems: 'start' }}>
                    <div>
