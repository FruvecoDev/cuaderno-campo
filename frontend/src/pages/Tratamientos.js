...
import { Plus, Edit2, Trash2, Info, Filter, Settings, X, Calculator, AlertTriangle, RotateCcw, Beaker, Droplets, Ruler, Bug, Database, ChevronDown, WifiOff, Download, TrendingUp, CheckCircle, Clock, Leaf, ArrowLeft } from 'lucide-react';
        ...
        <div style={{ marginBottom: '1.5rem' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '1rem', marginBottom: '1.5rem' }}>
            ...
            <div className="card" style={{ padding: '1rem', textAlign: 'center', background: 'linear-gradient(135deg, hsl(210 100% 50% / 0.1), hsl(210 100% 50% / 0.05))' }}>
              ...
              <div style={{ fontSize: '0.75rem', color: 'hsl(var(--muted-foreground))' }}>Hectáreas Tratadas</div>
            </div>
          </div>
