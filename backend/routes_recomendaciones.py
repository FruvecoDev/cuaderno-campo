...
async def create_recomendacion(
    ...
    recomendacion = {
        ...
        "superficie_tratada": data.superficie_tratada,
        "cantidad_total_producto": data.cantidad_total_producto,
        "volumen_total_agua": data.volumen_total_agua,
        "tiene_alertas": data.tiene_alertas,
        "alertas_bloqueantes": data.alertas_bloqueantes,
        "estado": "Pendiente",
